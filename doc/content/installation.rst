...
#. Copy the *rpm* file to the Fuel Master node:
   ::
      ...
      [root@home ~]# scp fuel-plugin-xenserver-1.1-1.1.0-1.noarch.rpm root@fuel-master:/tmp
...
#. Log into Fuel Master node and install the plugin using the
   ...
   ::
      ...
      [root@fuel-master ~]# fuel plugins --install /tmp/fuel-plugin-xenserver-1.1-1.1.0-1.noarch.rpm
...
#. Verify that the plugin is installed correctly:
   ::
     ...
     ---|-----------------------|---------|----------------
     9  | fuel-plugin-xenserver | 1.1.0   | 2.0.0

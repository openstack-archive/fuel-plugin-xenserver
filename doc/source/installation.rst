...
#. Copy the *rpm* file to the Fuel Master node:
   ::
      ...
      [root@home ~]# scp fuel-plugin-xenserver-3.1-3.1.1-1.noarch.rpm root@fuel:/tmp
...
#. Log into Fuel Master node and install the plugin using the
   ...
   ::
      ...
      [root@fuel-master ~]# fuel plugins --install /tmp/fuel-plugin-xenserver-3.1-3.1.1-1.noarch.rpm
...
#. Verify that the plugin is installed correctly:
   ::
     ...
     ---|-----------------------|---------|----------------
     1  | fuel-plugin-xenserver | 3.1.1   | 4.0.0

...
def get_private_network_ethX():
    ...
    # connect to the same network and "Assign public network to all nodes" is checked
    for item in values:
        if item['action'] == 'add-patch' and 'br-prv' in item['bridges'] and 'br-ex' in item['bridges']:
            break
    for item in values:

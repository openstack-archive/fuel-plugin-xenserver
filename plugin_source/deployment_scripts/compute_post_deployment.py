...
def create_dom0_mesh_bridge(himn, username, dom0_bridge, mesh_info):
    ...
    if exitcode == 1:
        ...
        utils.scp(himn, username, '/etc/systemd/system', 'mos-vxlan.service')
        utils.ssh(himn, username, 'systemctl', 'daemon-reload')
        utils.ssh(himn, username, 'systemctl', 'start', 'mos-vxlan.service')
...
def create_mesh_bridge_ifcfg(himn, username, bridge, mesh_info):

...
iso: suppack/xcp_2.1.0/xenapi-plugins-${OPENSTACK_RELEASE}.iso

suppack/xcp_2.1.0/xenapi-plugins-${OPENSTACK_RELEASE}.iso: plugin_source/deployment_scripts/patchset/xenhost
	suppack/build-xenserver-suppack.sh ${OPENSTACK_RELEASE} ${HYPERVISOR_NAME}

${BUILDROOT}/${PLUGIN_NAME}/branded: ${BRANDING} suppack/xcp_2.1.0/xenapi-plugins-${OPENSTACK_RELEASE}.iso plugin_source
	...
	cp -r suppack/xcp_2.1.0 ${BUILDROOT}/${PLUGIN_NAME}/deployment_scripts/
	cp -r suppack/xcp_2.1.4 ${BUILDROOT}/${PLUGIN_NAME}/deployment_scripts/
	cp -r suppack/xcp_1.9.0 ${BUILDROOT}/${PLUGIN_NAME}/deployment_scripts/
...
clean:
	rm -rf ${BUILDROOT} output suppack/xcp_2.1.0 suppack/xcp_2.1.4 suppack/build suppack/xcp_1.9.0 suppack/build

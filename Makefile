...
iso: suppack/dundee/xenapi-plugins-${OPENSTACK_RELEASE}.iso

suppack/dundee/xenapi-plugins-${OPENSTACK_RELEASE}.iso: plugin_source/deployment_scripts/patchset/xenhost
	suppack/build-xenserver-suppack.sh ${OPENSTACK_RELEASE} ${HYPERVISOR_NAME}

${BUILDROOT}/${PLUGIN_NAME}/branded: ${BRANDING} suppack/dundee/xenapi-plugins-${OPENSTACK_RELEASE}.iso plugin_source
	...
	cp -r suppack/dundee ${BUILDROOT}/${PLUGIN_NAME}/deployment_scripts/
	cp -r suppack/ely ${BUILDROOT}/${PLUGIN_NAME}/deployment_scripts/
...
clean:
	rm -rf ${BUILDROOT} output suppack/dundee suppack/ely suppack/build
